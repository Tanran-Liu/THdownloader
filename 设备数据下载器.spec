...
a = Analysis(
    ...
    hiddenimports=['config', 'config.config', 'download', 'download.async_downloader', 'download.db', 'tui_app', 'tkinter.font', 'tkinter.scrolledtext', 'mysql.connector', 'mysql.connector.errorcode', 'mysql.connector.errors', 'oss2', 'oss2.auth', 'oss2.api', 'oss2.models', 'oss2.exceptions', 'oss2.utils', 'oss2.http', 'oss2.compat', 'oss2.iterators', 'pandas', 'pandas._libs.tslibs', 'pandas.io.formats.style', 'openpyxl', 'openpyxl.workbook', 'openpyxl.worksheet', 'PIL', 'PIL._imaging', 'PIL.Image', 'PIL.ImageTk', 'ttkthemes', 'cryptography.hazmat.backends.openssl', 'dateutil.parser', 'dateutil.tz'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
